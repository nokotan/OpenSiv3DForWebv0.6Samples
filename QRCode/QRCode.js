...
function createExportWrapper(name, fixedasm) {
  ...
  var wasmBinaryFile = 'QRCode.wasm';
...
var ASM_CONSTS = {
  1849340: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 1850795: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 1851784: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 1851877: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 1851946: function() {return screen.width;},  
 1851971: function() {return screen.height;},  
 1851997: function() {return window.innerWidth;},  
 1852027: function() {return window.innerHeight;},  
 1852058: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 1852153: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 1852290: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 1852514: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 1853007: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 1853075: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 1854727: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 1855137: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 1855742: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 1856222: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }}
};
  ...
  function _siv3dCreateNotification(title, body, actionsNum, actionTexts, callback, callbackArg) {
          if (!window.Notification && Notification.permission !== "granted") {
              wasmTable.get(callback)(0, callbackArg);
              return 0;
          }
          ...
          siv3dRegisterUserAction(function () {
              ...
              wasmTable.get(callback)(idx, callbackArg);
          }); 
  ...
  function _siv3dGetClipboardText(callback, promise) {
          siv3dRegisterUserAction(function () {
              navigator.clipboard.readText()
              .then(str => {
                  const strPtr = allocate(intArrayFromString(str), ALLOC_NORMAL);       
                  wasmTable.get(callback)(strPtr, promise);
                  Module["_free"](strPtr);
              })
              .catch(e => {
                  wasmTable.get(callback)(0, promise);
              })
          });
  ...
  function _siv3dInitNotification() {
  ...
  function _siv3dQueryNotificationAvailability() {
  ...
  function _siv3dRegisterDragEnter(ptr) {
          Module["canvas"].ondragenter = function (e) {
              ...
              if (types.length > 0) {
                  wasmTable.get(ptr)(types[0] === 'Files' ? 1 : 0);
              }        
          };
      }
  ...
  function _siv3dRegisterNotificationCallback(id, callback, callbackArg) {
          ...
          notificattion.onclick = function() {
              wasmTable.get(callback)(id, 1 /* ToastNotificationState.Activated */, callbackArg);
          }
          notificattion.onshow = function() {
              wasmTable.get(callback)(id, 2 /* ToastNotificationState.Shown */, callbackArg);
          }
          notificattion.onclose = function() {
              wasmTable.get(callback)(id, 5 /* ToastNotificationState.TimedOut */, callbackArg);
          }
          notificattion.onerror = function() {
              wasmTable.get(callback)(id, 6 /* ToastNotificationState.Error */, callbackArg);
          }
      }
              ...
              if (e.inputType == "insertText") {
                  if (e.data) {
                      for (let i = 0; i < e.data.length; i++) {
                          ...
                          wasmTable.get(callback)(codePoint);
                      }
                  }
              }    
          });
...
var asmLibraryArg = {
  ...
  "siv3dInitNotification": _siv3dInitNotification,
  ...
  "siv3dQueryNotificationAvailability": _siv3dQueryNotificationAvailability,
...
if (!Object.getOwnPropertyDescriptor(Module, "siv3dDragDropFileReader")) Module["siv3dDragDropFileReader"] = function() { abort("'siv3dDragDropFileReader' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "videoElements")) Module["videoElements"] = function() { abort("'videoElements' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dOpenVideoStream")) Module["siv3dOpenVideoStream"] = function() { abort("'siv3dOpenVideoStream' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dActiveTouches")) Module["siv3dActiveTouches"] = function() { abort("'siv3dActiveTouches' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dOnTouchStart")) Module["siv3dOnTouchStart"] = function() { abort("'siv3dOnTouchStart' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dOnTouchEnd")) Module["siv3dOnTouchEnd"] = function() { abort("'siv3dOnTouchEnd' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dOnTouchMove")) Module["siv3dOnTouchMove"] = function() { abort("'siv3dOnTouchMove' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dHasUserActionTriggered")) Module["siv3dHasUserActionTriggered"] = function() { abort("'siv3dHasUserActionTriggered' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dPendingUserActions")) Module["siv3dPendingUserActions"] = function() { abort("'siv3dPendingUserActions' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dTriggerUserAction")) Module["siv3dTriggerUserAction"] = function() { abort("'siv3dTriggerUserAction' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dRegisterUserAction")) Module["siv3dRegisterUserAction"] = function() { abort("'siv3dRegisterUserAction' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dUserActionHookCallBack")) Module["siv3dUserActionHookCallBack"] = function() { abort("'siv3dUserActionHookCallBack' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dInputElement")) Module["siv3dInputElement"] = function() { abort("'siv3dInputElement' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dDialogFileReader")) Module["siv3dDialogFileReader"] = function() { abort("'siv3dDialogFileReader' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dDownloadLink")) Module["siv3dDownloadLink"] = function() { abort("'siv3dDownloadLink' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dSaveFileBuffer")) Module["siv3dSaveFileBuffer"] = function() { abort("'siv3dSaveFileBuffer' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dSaveFileBufferWritePos")) Module["siv3dSaveFileBufferWritePos"] = function() { abort("'siv3dSaveFileBufferWritePos' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dDefaultSaveFileName")) Module["siv3dDefaultSaveFileName"] = function() { abort("'siv3dDefaultSaveFileName' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dWriteSaveFileBuffer")) Module["siv3dWriteSaveFileBuffer"] = function() { abort("'siv3dWriteSaveFileBuffer' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dFlushSaveFileBuffer")) Module["siv3dFlushSaveFileBuffer"] = function() { abort("'siv3dFlushSaveFileBuffer' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dTextInputElement")) Module["siv3dTextInputElement"] = function() { abort("'siv3dTextInputElement' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "siv3dNotifications")) Module["siv3dNotifications"] = function() { abort("'siv3dNotifications' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };
