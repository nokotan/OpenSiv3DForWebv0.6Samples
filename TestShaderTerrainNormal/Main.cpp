...
void Main()
{
	...
	const VertexShader vsTerrain = HLSL{ U"example/shader/hlsl/terrain_forward.hlsl", U"VS" }
		...
		| WGSL{ U"example/shader/wgsl/terrain_forward.vert.wgsl", {{ U"VSPerView", 1 }, { U"VSPerObject", 2 }} };
	...
	const PixelShader psTerrain = HLSL{ U"example/shader/hlsl/terrain_forward.hlsl", U"PS" }
		...
		| WGSL{ U"example/shader/wgsl/terrain_forward.frag.wgsl", {{ U"PSPerFrame", 0 }, { U"PSPerView", 1 }, { U"PSPerMaterial", 3 }} };
